"""Parser for Python literate documents with Markdown in comments."""
...
def parse_python(content: str, source_path: str | None = None) -> Document:
    """Parse a Python literate document."""
